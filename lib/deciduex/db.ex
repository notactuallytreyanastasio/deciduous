defmodule Deciduex.DB do
  ...
  """
  def ensure_schema(repo) do
    # Core tables
    ensure_table(repo, :decision_nodes, """
    ...
    ensure_table(repo, :decision_edges, """
    ...
    ensure_table(repo, :node_documents, """
    ...
    ensure_table(repo, :decision_sessions, """
    ...
    ensure_table(repo, :session_nodes, """
  ...
  defp ensure_table(repo, _name, sql) do
    SQL.query(repo, sql, [])
  end

  defp ensure_indexes(repo) do
    indexes = [
