...
Complete the [local setup](local-postgres.md) first. The remote example is a deployment outline, not a hardened hosting platform or a managed service.
